      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <div className="flex mt-2 justify-start items-center gap-4">
            <i className="fa fa-user-circle scale-150 text-gray-300"></i>
            <p className="text-gray-300 font-medium">{item.name}</p>
          </div>
          <p className="mt-3 text-gray-300 border-b pb-4 border-dashed">
            {item.message}
          </p>
        </div>
        <div className="text-gray-500 hover:text-sky-500 cursor-pointer p-10">
